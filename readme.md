# <span style="color: #3b82f6;">The</span> <img src="image.png" style="width:10rem"><span style="color: #3b82f6;"> Index</span>   


<div style="display: flex; gap: 10px;">

<a href="https://op-dekho.vercel.app/" style="background: #111; padding: 20px; border-radius: 12px; width: 200px;" target="_blank">
    <p>🌀 <strong style="color: #fef08a;">One Piece Dekho</strong></p>
